...
class TestDelayMethods(TestBaseAppConfig):
...
class TestDelayMethodsnotEnabled(TestBaseAppConfig):
...
class TestDelayMethodslowrate(TestBaseAppConfig):
...
class TestDelayEnabledNoDelay(TestBaseAppConfig):
...
class TestDelayEnabledDelayNotInt(TestBaseAppConfig):
