...
class TestExceptionMethods(TestBaseSSM):
...
class TestExceptionMethodslowrate(TestBaseSSM):
...
class TestExceptionMethodsnotenabled(TestBaseSSM):
...
class TestExceptionMethodsNoMSG(TestBaseSSM):
