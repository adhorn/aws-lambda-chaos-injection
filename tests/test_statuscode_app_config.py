...
class TestStatusCodeMethods(TestBaseAppConfig):
...
class TestStatusCodeMethodslowrate(TestBaseAppConfig):
...
class TestStatusCodeMethodsnotenabled(TestBaseAppConfig):
...
class TestStatusCodeNoError_Code(TestBaseAppConfig):
...
class TestErrorCodeNotValid(TestBaseAppConfig):
